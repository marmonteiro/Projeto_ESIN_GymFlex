...
VALUES 
  ...
  ('c0b68fe8e9a7e88aae155fe4f10dc312af18f2542758f1b8f882f544a11e20cc', 60.0, 170, (60.0 / (1.70 * 1.70)), 'F' , (SELECT id FROM Pessoa WHERE nome = 'Luisa Costa'), (SELECT id FROM Pessoa WHERE nome = 'Ricardo Fernandes'),'1234567800001234'),
  ('9a78a68f68c4586a8959685241fe28a8f94a3e867d6b8591458dfc941d5421d4', 70.0, 175, (70.0 / (1.75 * 1.75)), 'M' , (SELECT id FROM Pessoa WHERE nome = 'André Santos'), (SELECT id FROM Pessoa WHERE nome = 'Lara Marques'),'1234567800001234');
...
VALUES 
  ('2022-07-01', (SELECT id FROM Pessoa WHERE nome = 'João Silva'), 'Básico'),
...
VALUES 
  ('Cycling', 15, 'Segunda-Feira', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 'imagens/aulasgrupo/cycling.png'),
  ('Pilates', 10, 'Terça-Feira', '10:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '10:00')) / 3600.0, 'imagens/aulasgrupo/pilates.png'),
...
VALUES 
  ('2023-11-20', 15, 1, 'Cycling'),
  ('2023-11-21', 7, 1, 'Pilates'),  
  ('2023-11-22', 9, 1, 'Body Step'),
  ('2023-11-23', 6, 1, 'Body Pump'),
  ('2023-11-24', 7, 1, 'Zumba'),
  ('2023-11-25', 8, 1, 'Xpress Abs'),
  ('2023-11-27', 1, 1, 'Cycling'),
  ('2023-11-28', 7, 1, 'Pilates'),  
  ('2023-11-29', 9, 1, 'Body Step'),
  ('2023-11-30', 6, 1, 'Body Pump'),
  ('2023-12-01', 7, 1, 'Zumba'),
  ('2023-12-02', 8, 1, 'Xpress Abs'),
  ('2023-12-04', 1, 1, 'Cycling'),
  ('2023-12-05', 7, 1, 'Pilates'),  
  ('2023-12-06', 9, 1, 'Body Step'),
  ('2023-12-07', 6, 1, 'Body Pump'),
  ('2023-12-08', 7, 1, 'Zumba'),
  ('2023-12-09', 8, 1, 'Xpress Abs'),
  ('2023-12-11', 1, 1, 'Cycling'),
  ('2023-12-12', 7, 1, 'Pilates'),  
  ('2023-12-13', 9, 1, 'Body Step'),
  ('2023-12-14', 6, 1, 'Body Pump'),
  ('2023-12-15', 10, 1, 'Zumba'),
  ('2023-12-16', 6, 1, 'Xpress Abs'),
  ('2023-12-18', 4, 1, 'Cycling'),
  ('2023-12-19', 7, 1, 'Pilates'),  
  ('2023-12-20', 9, 1, 'Body Step'),
  ('2023-12-21', 7, 1, 'Body Pump'),
  ('2023-12-22', 5, 1, 'Zumba'),
  ('2023-12-23', 4, 1, 'Xpress Abs'),
  ('2023-12-25', 3, 1, 'Cycling'),
  ...
  ('2023-11-20', 4, 2, 'Cycling'),
    ('2023-11-21', 9, 2, 'Pilates'),  
    ('2023-11-22', 1, 2, 'Body Step'),
    ('2023-11-23', 7, 2, 'Body Pump'),
    ('2023-11-24', 3, 2, 'Zumba'),
    ('2023-11-25', 5, 2, 'Xpress Abs'),
    ('2023-11-27', 8, 2, 'Cycling'),
    ('2023-11-28', 0, 2, 'Pilates'),  
    ('2023-11-29', 6, 2, 'Body Step'),
    ('2023-11-30', 2, 2, 'Body Pump'),
    ('2023-12-01', 10, 2, 'Zumba'),
    ('2023-12-02', 4, 2, 'Xpress Abs'),
    ('2023-12-04', 7, 2, 'Cycling'),
    ('2023-12-05', 3, 2, 'Pilates'),  
    ('2023-12-06', 1, 2, 'Body Step'),
    ('2023-12-07', 9, 2, 'Body Pump'),
    ('2023-12-08', 5, 2, 'Zumba'),
    ('2023-12-09', 8, 2, 'Xpress Abs'),
    ('2023-12-11', 2, 2, 'Cycling'),
    ('2023-12-12', 6, 2, 'Pilates'),  
    ('2023-12-13', 4, 2, 'Body Step'),
    ('2023-12-14', 3, 2, 'Body Pump'),
    ('2023-12-15', 7, 2, 'Zumba'),
    ('2023-12-16', 5, 2, 'Xpress Abs'),
    ('2023-12-18', 1, 2, 'Cycling'),
    ('2023-12-19', 9, 2, 'Pilates'),  
    ('2023-12-20', 8, 2, 'Body Step'),
    ('2023-12-21', 20, 2, 'Body Pump'),
    ('2023-12-22', 6, 2, 'Zumba'),
    ('2023-12-23', 4, 2, 'Xpress Abs'),
    ('2023-12-25', 15, 2, 'Cycling'),
  ...
  ('2023-11-20', 4, 3, 'Cycling'),
    ('2023-11-21', 9, 3, 'Pilates'),  
    ('2023-11-22', 1, 3, 'Body Step'),
    ('2023-11-23', 7, 3, 'Body Pump'),
    ('2023-11-24', 3, 3, 'Zumba'),
    ('2023-11-25', 5, 3, 'Xpress Abs'),
    ('2023-11-27', 8, 3, 'Cycling'),
    ('2023-11-28', 6, 3, 'Pilates'),  
    ('2023-11-29', 2, 3, 'Body Step'),
    ('2023-11-30', 5, 3, 'Body Pump'),
    ('2023-12-01', 4, 3, 'Zumba'),
    ('2023-12-02', 3, 3, 'Xpress Abs'),
    ('2023-12-04', 9, 3, 'Cycling'),
    ('2023-12-05', 1, 3, 'Pilates'),  
    ('2023-12-06', 7, 3, 'Body Step'),
    ('2023-12-07', 0, 3, 'Body Pump'),
    ('2023-12-08', 8, 3, 'Zumba'),
    ('2023-12-09', 4, 3, 'Xpress Abs'),
    ('2023-12-11', 6, 3, 'Cycling'),
    ('2023-12-12', 3, 3, 'Pilates'),  
    ('2023-12-13', 5, 3, 'Body Step'),
    ('2023-12-14', 2, 3, 'Body Pump'),
    ('2023-12-15', 9, 3, 'Zumba'),
    ('2023-12-16', 7, 3, 'Xpress Abs'),
    ('2023-12-18', 0, 3, 'Cycling'),
    ('2023-12-19', 8, 3, 'Pilates'),  
    ('2023-12-20', 4, 3, 'Body Step'),
    ('2023-12-21', 5, 3, 'Body Pump'),
    ('2023-12-22', 1, 3, 'Zumba'),
    ('2023-12-23', 0, 3, 'Xpress Abs'),
...
((SELECT id FROM Pessoa WHERE nome = 'João Silva'), 3),
((SELECT id FROM Pessoa WHERE nome = 'João Silva'), 4),
((SELECT id FROM Pessoa WHERE nome = 'João Silva'), 5),
((SELECT id FROM Pessoa WHERE nome = 'João Silva'), 6),
((SELECT id FROM Pessoa WHERE nome = 'João Silva'), 13);
...
VALUES 
  ...
  ('2023-11-27', '09:00', '10:00', (strftime('%s', '10:00') - strftime('%s', '09:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-11-07', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-11-03', '09:30', '10:30', (strftime('%s', '10:30') - strftime('%s', '09:30')) / 3600.0, 2, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-10-14', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 3, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-10-24', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-09-29', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-09-27', '09:00', '10:00', (strftime('%s', '10:00') - strftime('%s', '09:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-09-23', '15:00', '16:00', (strftime('%s', '16:00') - strftime('%s', '15:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-09-15', '17:00', '18:00', (strftime('%s', '18:00') - strftime('%s', '17:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-08-30', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-08-25', '09:00', '10:00', (strftime('%s', '10:00') - strftime('%s', '09:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-08-23', '15:00', '16:00', (strftime('%s', '16:00') - strftime('%s', '15:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-01-15', '12:00', '14:00', (strftime('%s', '14:00') - strftime('%s', '12:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-03-15', '13:00', '14:00', (strftime('%s', '14:00') - strftime('%s', '13:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-05-15', '17:00', '18:00', (strftime('%s', '18:00') - strftime('%s', '17:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-12-01', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-12-02', '09:30', '10:30', (strftime('%s', '10:30') - strftime('%s', '09:30')) / 3600.0, 2, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-12-14', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 3, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-11-20', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-11-20', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-11-27', '09:00', '10:00', (strftime('%s', '10:00') - strftime('%s', '09:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-10-23', '15:00', '16:00', (strftime('%s', '16:00') - strftime('%s', '15:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-10-15', '17:00', '18:00', (strftime('%s', '18:00') - strftime('%s', '17:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-10-15', '12:00', '14:00', (strftime('%s', '14:00') - strftime('%s', '12:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-09-15', '13:00', '14:00', (strftime('%s', '14:00') - strftime('%s', '13:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2022-09-15', '17:00', '18:00', (strftime('%s', '18:00') - strftime('%s', '17:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva'));
