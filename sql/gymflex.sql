...
VALUES 
  ...
  ('2023-10-03', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-10-07', '09:30', '10:30', (strftime('%s', '10:30') - strftime('%s', '09:30')) / 3600.0, 2, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-10-14', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 3, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-10-20', '10:00', '11:00', (strftime('%s', '11:00') - strftime('%s', '10:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ('2023-09-20', '11:00', '12:00', (strftime('%s', '12:00') - strftime('%s', '11:00')) / 3600.0, 1, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
  ...
  ('2022-12-07', '09:30', '10:30', (strftime('%s', '10:30') - strftime('%s', '09:30')) / 3600.0, 2, (SELECT id FROM Pessoa WHERE nome = 'João Silva')),
