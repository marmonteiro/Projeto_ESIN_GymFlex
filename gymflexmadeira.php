...
<body>
    <header>
        ...
        <h1>GymFlex Madeira</h1>
        <h2>O seu ginásio na ilha da Madeira.</h2>
        <h3>Situados na Rua da Ajuda, esperamos a sua visita.</h3>
    </header>
    ...
    <div class="club-info">
        <p>GymFlex Lisboa: Rua da Ajuda, nº8</p>
        <p>Contacto telefónico: 923524352</p>
        <p>Email: gymflex.madeira@gmail.com</p> 
    ...
    <img class="mapa" src="imagens/gymflexmadeira.png" alt="Mapa GymFlex Madeira"> 
    
    <div class="horarios">
        <p> Horário do ginásio:</p>
        <ul>
            <li>Sábados das 9h às 21h.</li>
            <li>2ª Feira a 6ª Feira das 7h às 21h.</li>
